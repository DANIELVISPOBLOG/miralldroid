...
public final class Server {
    ...
    private static final String SERVER_PATH = "/data/local/tmp/miralldroid-server.jar";

    private Server() {
        // not instantiable
    }

    private static void miralldroid(Options options) throws IOException {
